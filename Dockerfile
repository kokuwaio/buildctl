...
FROM docker.io/library/bash:5.3.15@sha256:66b753fd64a652fdaf62121cb4fdbdcbe3c80810f00c33b3b175fde8d0272802
...
RUN wget -q "https://github.com/moby/buildkit/releases/download/v0.30.0/buildkit-v0.30.0.linux-$TARGETARCH.tar.gz" --output-document=- | \
